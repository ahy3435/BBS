			...
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td><textarea type="text" class="form-control" placeholder="글 내용 name="bbsContent" maxlength="2048" height=350px;"></textarea></td>
					<!-- textarea:장문의 글 작성 시 사용 -->
					</tr>
				</tbody>
			</table>
			<!-- 글쓰기 버튼 생성 - 버튼 오른쪽에 고정되도록 만들어줌-->
			<input type="submit" class="btn btn-primary pull-right" valus="글쓰기">
		</form>
		</div>
